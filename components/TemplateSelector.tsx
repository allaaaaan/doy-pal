...
import { ChevronDownIcon, XMarkIcon, SparklesIcon, ClockIcon } from "@heroicons/react/24/outline";
    ...
    <div className="relative">
      ...
      >
        {selectedTemplate ? (
          ...
          <div className="flex items-center justify-between">
            <span className="text-gray-500">Choose a template or create manually</span>
            <ChevronDownIcon className={`h-4 w-4 text-gray-400 transition-transform ${isOpen ? 'rotate-180' : ''}`} />
          </div>
        )}
      </div>
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">Enter custom event details</div>
                </div>
              </div>
            </button>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {template.frequency > 0 && (
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-xs text-gray-400">{template.frequency}</span>
                        </div>
                      )}
                    </div>
                  </div>
